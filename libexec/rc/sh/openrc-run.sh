...
sourcex "/libexec/rc/sh/functions.sh"
sourcex "/libexec/rc/sh/rc-functions.sh"
case $RC_SYS in
	PREFIX|SYSTEMD-NSPAWN) ;;
	*) sourcex -e "/libexec/rc/sh/rc-cgroup.sh";;
esac
...
sourcex "/libexec/rc/sh/runit.sh"
sourcex "/libexec/rc/sh/s6.sh"
sourcex "/libexec/rc/sh/start-stop-daemon.sh"
sourcex "/libexec/rc/sh/supervise-daemon.sh"
